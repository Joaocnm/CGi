...
public class TelaLogin extends JFrame {
	...
	public TelaLogin() {
		...
		JButtonCadastrar.setBorderPainted(false); //bordas feias 
		JButtonCadastrar.setFocusPainted(false);
		JButtonCadastrar.setContentAreaFilled(true);
		
		//luizinha no botao
		JButtonCadastrar.addMouseListener(new java.awt.event.MouseAdapter() {
		    public void mouseEntered(java.awt.event.MouseEvent evt) {
		        JButtonCadastrar.setBackground(new Color(255, 100, 100)); //brilha
		    }
		    public void mouseExited(java.awt.event.MouseEvent evt) {
		        JButtonCadastrar.setBackground(new Color(255, 30, 30)); //para
		    }
		});
		...
		JButtonLogin.setBorderPainted(false); //bordas feias 
		JButtonLogin.setFocusPainted(false);
		JButtonLogin.setContentAreaFilled(true);
		
		JButtonLogin.addMouseListener(new java.awt.event.MouseAdapter() {
		    public void mouseEntered(java.awt.event.MouseEvent evt) {
		        JButtonLogin.setBackground(new Color(130, 230, 255)); 
		    }
		    public void mouseExited(java.awt.event.MouseEvent evt) {
		        JButtonLogin.setBackground(new Color(0, 200, 255));
		    }
		});
		...
		btnEsqueci.setBounds(397, 349, 179, 20); 
		...
		btnEsqueci.addActionListener(e -> {
		    new TelinhaRedefinirSenha().setVisible(true);
		});
		...
		lblPlanoFundo.setIcon(new ImageIcon("C:\\Users\\Joao-PC\\Desktop\\CGI\\CGI.01\\bin\\imagens\\cgi\\imagem.telalogin.jpeg"));
