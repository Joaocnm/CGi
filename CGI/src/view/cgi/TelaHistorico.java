...
public class TelaHistorico extends JFrame {
	...
	public TelaHistorico(Usuario usuario) {
		...
		btnTodos.setContentAreaFilled(true);

		JButton btnFixos = new JButton("Fixos");
		btnFixos.setBounds(160, 40, 100, 30);
		btnFixos.setBackground(new Color(255, 214, 10));
		contentPane.add(btnFixos);
		btnFixos.setFocusPainted(false);
		btnFixos.setContentAreaFilled(true);
		...
		btnVariaveis.setFocusPainted(false);
		btnVariaveis.setContentAreaFilled(true);
		...
		btnMetas.setContentAreaFilled(true);
		...
		scrollPane.setBounds(29, 80, 736, 310);
		...
		lblRenda.setForeground(new Color(240, 240, 240));
